...
console.log(`Generated class name options: ${JSON.stringify(classNameOptions)}`)
  ...
  <Page>
    ...
    >
      ...
      <Section title={
          ...
          <Text bold={true}>SSIS-FitBit -
          <Link source="https://20alse.ssis.nu/fitbit">https://20alse.ssis.nu/fitbit</Link> -
          <Text>Skapad med kärlek av Albin TE20A</Text> -
          <Text>Open source på <Link source="https://github.com/sotpotatis/ssis-fitbit">GitHub</Link>.</Text>
          </Text>
      </Section>
  </Page>
));
